...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("webapp");
        ...
        config.getMapConfigs().put("com.dmf.webapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
